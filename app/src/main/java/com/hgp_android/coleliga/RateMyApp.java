...
public class RateMyApp {
    ...
    public void showRateDialog(final SharedPreferences.Editor editor) {
        ...
        View layout = inflater.inflate(R.layout.dialog_valoramiapp, null);
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, "carponcal@gmail.com");
                intent.putExtra(Intent.EXTRA_SUBJECT, "Coleliga Issue: ");
                intent.putExtra(Intent.EXTRA_TEXT, "Please, explain the issue");
